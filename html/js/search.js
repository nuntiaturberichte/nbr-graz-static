const project_collection_name = "nbr-graz"
const main_search_field = "full_text"
const search_api_key = "MEM7OptDUZ3gCF7L6jKbKWDQ50xdYbRv"  // custom search only key
...
search.addWidgets([
    ...
    instantsearch.widgets.panel({
        ...
        templates: {
            header: 'Band der Druckausgabe',
        },
    })(instantsearch.widgets.refinementList)({
        container: "#refinement-list-volume ",
        attribute: "volume",
        searchable: true,
        showMore: true,
        showMoreLimit: 50,
        limit: 10,
        searchablePlaceholder: "Suche nach Bänden",
    ...
    instantsearch.widgets.panel({
        ...
        showMoreLimit: 50,
        limit: 10,
        searchablePlaceholder: "Suche nach Absender",
        cssClasses: DEFAULT_CSS_CLASSES,
    }),
    instantsearch.widgets.panel({
        collapsed: ({ state }) => {
